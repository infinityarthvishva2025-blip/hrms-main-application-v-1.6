...
const ACTION_HISTORY_SCHEM = new mongoose.Schema(
  {
    action:{
      type:String , enum:['Applied' , "Approved" , 'Rejected' , "Remarked"],
      required:true,
    },
    byEmployeeId:{type:mongoose.Schema.Types.ObjectId , ref:'Employee' , required:true},
    byName:{type:String} , byRole:{type:String} , remarks:{type:String , default:''} , timestamp:{type:Date , default:Date.now},
  }
)
